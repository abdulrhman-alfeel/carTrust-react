...
import { Flex, Avatar, Text, Link, Box, Button } from "@chakra-ui/react";
...
import { Evaluation } from "../redux/features/dataSlice";

export default function EvaluationDetails() {
  const data = JSON.parse(localStorage.getItem(`picelment`));
  ...
  const id_Car = urlData?.split("&")[1];
  const trim = urlData?.split("&")[2];
  ...
  useEffect(() => {
    console.log(data, "idcarrrrrrrrrrrr");
  }, []);

  const Avatar_advertins = (imag) => {
    return (
      <Flex w="100%" h="241px" borderRadius="10px" background="#2D3291">
        <Flex position="absolute" zIndex={1} flexDir="column">
          <Flex
          ...
          >
            ...
            >
              <path
                d="M22.6418 81.8335L0.577148 0.00012207H22.6418H44.7064L66.7711 81.8335L44.7064 163.667H22.6418H0.577148L22.6418 81.8335Z"
                fill="white"
                fill-opacity="0.03"
              />
            </svg>
            ...
            >
              <path
                d="M22.6955 81.8335L0.630859 0.00012207H22.6955H44.7602L66.8248 81.8335L44.7602 163.667H22.6955H0.630859L22.6955 81.8335Z"
                fill="white"
                fill-opacity="0.03"
              />
            </svg>
        ...
        <img style={{ margin: "auto" }} zIndex={2} width="60%" src={imag} />
      </Flex>
    );
  };
  return (
    <div style={{ backgroundColor: "#F6F7F9" }}>
      ...
      {data.map((pic) => (
        ...
        >
          <Flex
            width={window.innerWidth < 960 ? "100%" : "80%"}
            ...
            justify="flex-end"
          >
            <Text color={color.colorSub} fontSize={fontTitl.titleMedim_d}>
              التقييمات / تفاصيل التقييم
            </Text>
          </Flex>
          <Flex
            w="100%"
            ...
            flexDir="column"
          >
            {Avatar_advertins(pic.vehicle_image)}
          </Flex>
          <Flex
            // border='solid 1px #000'
            ...
            >
              ...
              >
                ...
                flexDir="column" w="50%">
                  ...
                  <Text fontSize={fontTitl.titleHome} fontWeight={700}>
                    {pic.model} {pic.trim}
                  </Text>
                  <Text
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path
                          d="M22.6562 8.33341C22.6562 8.7605 22.3021 9.11466 21.875 9.11466H3.125C2.69792 9.11466 2.34375 8.7605 2.34375 8.33341C2.34375 7.90633 2.69792 7.55216 3.125 7.55216H4.1875L4.58333 5.66675C4.95833 3.84383 5.73958 2.16675 8.84375 2.16675H16.1562C19.2604 2.16675 20.0417 3.84383 20.4167 5.66675L20.8125 7.55216H21.875C22.3021 7.55216 22.6562 7.90633 22.6562 8.33341Z"
                          fill="#90A3BF"
                        />
                        <path
                          d="M23.1045 14.2291C22.9482 12.5104 22.4899 10.6771 19.1461 10.6771H5.85448C2.51073 10.6771 2.06281 12.5104 1.89615 14.2291L1.31281 20.5729C1.2399 21.3646 1.50031 22.1562 2.04198 22.75C2.59406 23.3541 3.37531 23.6979 4.20865 23.6979H6.16698C7.85448 23.6979 8.1774 22.7291 8.38573 22.0937L8.59406 21.4687C8.83365 20.75 8.89615 20.5729 9.83365 20.5729H15.167C16.1045 20.5729 16.1357 20.6771 16.4066 21.4687L16.6149 22.0937C16.8232 22.7291 17.1461 23.6979 18.8336 23.6979H20.792C21.6149 23.6979 22.4066 23.3541 22.9586 22.75C23.5003 22.1562 23.7607 21.3646 23.6878 20.5729L23.1045 14.2291ZM9.37531 16.4062H6.25031C5.82323 16.4062 5.46906 16.0521 5.46906 15.625C5.46906 15.1979 5.82323 14.8437 6.25031 14.8437H9.37531C9.8024 14.8437 10.1566 15.1979 10.1566 15.625C10.1566 16.0521 9.8024 16.4062 9.37531 16.4062ZM18.7503 16.4062H15.6253C15.1982 16.4062 14.8441 16.0521 14.8441 15.625C14.8441 15.1979 15.1982 14.8437 15.6253 14.8437H18.7503C19.1774 14.8437 19.5316 15.1979 19.5316 15.625C19.5316 16.0521 19.1774 16.4062 18.7503 16.4062Z"
                          fill="#90A3BF"
                        />
                      </svg>
                      <Text mr={10}>المصنع</Text>
                    </Flex>
                    <Flex
                    flexDir='row-reverse'
                      mt={10}
                  ...
                  <Flex
                    ...
                    flexDir="column"
                  >
                    <Text mb={10}>{pic.make}</Text>
                    <Text mb={10}>{pic.trim}</Text>
                    <Text mb={10}>{pic.color}</Text>
                  </Flex>
                </Flex>
                {/* ********** */}
                {window.innerWidth < 960 ? <hr /> : null}
                <Flex
                  w={window.innerWidth < 960 ? "100%" : "50%"}
                  mr={-45}
                  flexDir='row-reverse'
                  justifyContent={
                    window.innerWidth < 960 ? "space-between" : "space-around"
                  }
                  //  border='solid 1px #000'
                >
                  <Flex flexDir="column">
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <path
                          d="M22 16C22 19.31 19.31 22 16 22C15.2555 22 14.5393 21.8643 13.8811 21.6141C13.5624 21.4929 13.503 21.0851 13.7248 20.8262C14.8668 19.4938 15.5 17.786 15.5 16C15.5 15.66 15.47 15.32 15.42 15C15.3902 14.8155 15.4844 14.6342 15.6478 14.5437C16.9719 13.8107 18.0532 12.6875 18.727 11.3153C18.8609 11.0427 19.1968 10.923 19.4452 11.0977C20.9863 12.1818 22 13.9755 22 16Z"
                          fill="#90A3BF"
                        />
                      </svg>
                      <Text ml={5}>طراز</Text>
                  ...
                  {window.innerWidth < 960 ? (
                    ...
                    <Flex
                      ...
                      // justifyContent='space-around'
                      align={
                        window.innerWidth < 960 ? "flex-start" : "flex-end"
                      }
                      // justifyContent='space-around'
                      flexDir="column"
                    >
                      <Text m={5}>{pic.model}</Text>
                      <Text m={5}>{pic.year}</Text>
                    </Flex>
                  )}
                </Flex>
              </Flex>

              <Flex mt={40} mb={50} w="100%" justifyContent="space-between">
                <Flex
                  flexDir="column"
                  justifyContent="space-between"
                  // border='solid 2px #000'
                >
                  <Flex mt={15}>
                    ...
                    <Text color="#2D3291" ml={5} fontWeight={700}>
                      ideal Price
                    </Text>
                  </Flex>
                  <Flex mt={15}>
                    ...
                    <Text color="#64BB6A" ml={5} fontWeight={700}>
                      Market Price
                    </Text>
                  </Flex>
                  <Flex mt={15}>
                    ...
                    <Text color="#41A2DC" ml={5} fontWeight={700}>
                      Quick Sell
                    </Text>
                  </Flex>
                </Flex>
                <Flex
                  ...
                  flexDir="column"
                >
                         <Text color="#2D3291 " fontWeight={700} mt={15}>
                    {parseInt(pic.upper_limit)
                      .toFixed(2)
                      .replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")}{" "}
                    SAR
                  </Text>
              
                  <Text color="#64BB6A" fontWeight={700} mt={15}>
                    {parseInt(pic.lower_limit)
                      .toFixed(2)
                      .replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")}{" "}
                    SAR
                  </Text>
                  <Text color="#41A2DC" fontWeight={700} mt={15}>
                    {parseInt(pic.evaluated_price)
                      .toFixed(2)
                      .replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")}{" "}
                    SAR
                  </Text>
              ...
              >
                <Flex flexDir="column" align="flex-end">
                  ...
                  <Text
                    ...
                    pl={padding - 7}
                  >
                    يرجى تقييم الخدمة للحصول على تجربة أفضل!{" "}
                  </Text>
                </Flex>
                <Flex
                  background="#F6F7F9"
                  // border='solid 2px #000'
                  height={window.innerWidth > 960 ? "50%" : null}
                  flexDir="column"
                  justifyContent="space-between"
                  borderRadius="10px"
                  pl={padding}
                >
                  ...
                  <Flex
                    ...
                    mb={20}
                    // ml={10}
                    flexDir={window.innerWidth < 960 ? "column-reverse" : "row"}
                  >
                    <Flex
                      mb={15}
                      // border='solid 2px #000'
                      w={window.innerWidth > 960 ? "60%" : "90%"}
                    >
                      <form style={{ width: "100%" }} class="form-floating">
                        ...
                        >
                          اكتب تعليقك من اجل مساعدتنا في تحسين الخدمة
                        </label>
                      </form>
                    </Flex>
                    <Flex justify="center" align="center" w="30%">
                      ...
                      >
                        <path
                          d="M20.0937 6.70913L22.3214 10.7378C22.6267 11.2908 23.3928 11.8161 24.0227 11.8871L27.7727 12.3585C30.1737 12.6551 30.7928 14.3591 29.1588 16.1438L26.375 19.1675C25.9103 19.6742 25.669 20.6408 25.8557 21.3043L26.8312 24.8641C27.5984 27.6745 26.1394 28.8394 23.5754 27.459L19.9937 25.5302C19.3414 25.1776 18.3052 25.2289 17.6924 25.6248L14.2827 27.8317C11.8419 29.4092 10.2887 28.3707 10.8243 25.5093L11.5102 21.8879C11.6382 21.211 11.3312 20.2663 10.8245 19.8016L7.78428 17.0133C6.01 15.3732 6.48727 13.6252 8.85158 13.1296L12.5433 12.3585C13.1663 12.2232 13.8883 11.6521 14.1418 11.071L16.0332 6.8658C17.067 4.60013 18.8909 4.52874 20.0937 6.70913Z"
                          fill="#F5A200"
                        />
                      </svg>
                      <svg
          ...
          >
            <Flex justifyContent="space-between">
              ...
              >
                ...
                <Text color={color.colorSub} fontSize={fontTitl.titlesub}>
                  يرجى تقييم الخدمة للحصول على تجربة أفضل! !
                </Text>
              </Flex>
